...
import { IActivity, INFT, IPrice, IOwner } from "../interfaces/INFT";
...
export class NFTController extends AbstractEntity {
  protected data: INFT;
  protected table = "NFTs" as string;
  protected nftTable = "NFTs" as string;
  ...
  async getOwners(filters?: IQueryFilters): Promise<Array<IOwner> | IResponse> {
    try {
      if (this.mongodb) {
