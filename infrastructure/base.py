    ...
    def __init__(self, app: core.App, id: str, props: Dict, **kwargs) -> None:
        ...
        build = codebuild.PipelineProject(
            ...
            environment_variables={
                ...
                "MONGODB_HOST": "cluster0.p0nis.mongodb.net",
                "MONGODB_USER":"bryan",
                "MONGODB_PASSWORD": "Y6s8oMFKeuuIHhrC",
                "MONGODB_PORT": "27017",
                "JWT_SECRET": "I7zWsuJ2HLJxbEga0kIBsXPlryMwuLpIvPeigjRNdbFLTLKX54CgaCzpzR8SU//+B+hGxw5HzGUJsCmL9RVg5HoMb4qj4EsdlVETJdODks",
                "EMAIL_SERVICE_API_KEY": "e18e0072c4789d5930da01958cbb931d-2ac825a1-3deef25b",
                "EMAIL_SERVICE_DOMAIN": "mg.depo.io",
                "KUCOIN_SERVICE_API_KEY": "61b0685b254fe40001b45c80",
                "KUCOIN_SERVICE_PASSPHRASE": "6d3473d8-9040-4348-9f45-6c8f8fc99b06",
                "KUCOIN_SERVICE_PASSPHRASE": "Deposupport21!",
                "ENV_DEV": "STAGING",
